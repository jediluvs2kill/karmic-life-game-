...
export const release={version:'0.2.6',name:'Golden Path',date:'2026-09-23',truthState:'COMPLETED_BUILD'} as const;
export const releaseTitle=`Karmic Life OS v${release.version} — ${release.name}`;
